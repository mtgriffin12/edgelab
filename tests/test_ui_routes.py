...
def test_intraday_idea_batch_pages_return_concise_scoreboard() -> None:
    ...
    for phrase in [
        ...
        "fixed_parameters",
        "Field types",
        "instruments_to_test</code>: non-empty array of strings",
        "required_data</code>: array of strings",
        "expected_failure_modes</code>: non-empty array of strings",
        "fixed_parameters</code>: object with JSON-compatible values",
